            ...
            For Each Key In Me.data
                ...
                Else
                    If Key.StateNow = -32767 Then
                        ...
                        End If
                    End If
                    If Key.StatePrev <> Key.StateNow Then
...
Fin:        If Err.Number > 0 Then
        ...
        Class Class_KeyHandlers
            ...
            Function SetEvent(Key As Keys) As Object
                If _KEYS._Get(Key).StateNow = 0 Then
                    MainForm.UpdateArr(2)
                ElseIf _KEYS._Get(Key).StateNow = -32768 Then
                    MainForm.UpdateArr(1)
                End If
                Return True
            End Function
        End Class
